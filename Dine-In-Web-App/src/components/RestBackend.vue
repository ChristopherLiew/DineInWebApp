            ...
            <div class="seatupdatearea">
              <div class="seats">
                  <div class="vacancies">
                      ...
                      <input type="text" id="one_seaters" name="one_seaters" v-model="edited_vacancy.one_seater" placeholder="Update here">
                  </div>
                  <div class="vacancies">
                      <div class="tabletype">
                      ...
                      <input type="text" id="two_seaters" name="two_seaters" v-model="edited_vacancy.two_seater" placeholder="Update here">
                  </div>
                  <div class="vacancies">
                      <div class="tabletype">
                      ...
                      <input type="text" id="three_seaters" name="three_seaters" v-model="edited_vacancy.three_seater" placeholder="Update here">
                  </div>
                  <div class="vacancies">
                      <div class="tabletype">
                      ...
                      <input type="text" id="four_seaters" name="four_seaters" v-model="edited_vacancy.four_seater" placeholder="Update here">
                  </div>
                  <div class="vacancies">
                      <div class="tabletype">
                      ...
                      <input type="text" id="five_seaters" name="five_seaters" v-model="edited_vacancy.five_seater" placeholder="Update here">
                  </div>
              </div>
